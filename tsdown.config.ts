/**
 * Browser client bundle for cronjob-dsh-plugin, mirroring the DeepSeek
 ...
 * compile via lightningcss inside the bundle: importing `x.module.css`
...
export default defineConfig({
  ...
  sourcemap: true,
  clean: false,
  // Everything not provided by the loader module table must inline instead —
